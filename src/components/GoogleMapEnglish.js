    ...
    return (
        <div className='container'>
            <div className='upper-part'>
                <div>
                    <h1 className='header'>Meat Map</h1>
                </div>
                <hr />
                <div className='searchbar'>
                    <p style={{'marginBottom': '0rem', 'fontWeight': '1000'}}>Find Restaurant:</p>
                    <input 
                ...
                <div className='btn-icons-container row'>
                    <div className='description-button-container col-lg-6 col-md-12 col-sm-12'>
                        <div className='description'>
                            <p>Select meat to be displayed:</p>
                        </div>
                        <div className='buttons'>
                            <button className={btnClassCow} onClick={() => setMeatSelector('cow')}>Cow <img src='/cow.svg' style={{width: '1rem'}} alt='cow'/></button>
                            <button className={btnClassPork} onClick={() => setMeatSelector('pork')}>Pork <img src='/pig.svg' style={{width: '1rem'}} alt='pig'/></button>
                            <button className={btnClassChicken} onClick={() => setMeatSelector('chicken')}>Chicken <img src='/chicken.svg' style={{width: '1rem'}} alt='chicken'/></button>
                            <button className={btnClassLamb} onClick={() => setMeatSelector('lamb')}>Lamb <img src='/sheep.svg' style={{width: '1rem'}} alt='lamb'/></button>
                            <button className={btnClassGoat} onClick={() => setMeatSelector('goat')}>Goat <img src='/goat.svg' style={{width: '1rem'}} alt='goat'/></button>
                        </div>
                    </div>
                    <div className='origin-icons-container col-lg-6 col-md-12 col-sm-12'>
                        ...
                        <div className='all-icons'>
                            <div className='icons'>
                                <img src={icons[0]} alt='suomi' /><span className='icon-text'>Finnish</span>
                            </div>
                            <div className='icons'>
                                <img src={icons[1]} alt='eu' /><span className='icon-text'>EU area</span>
                            </div>
                            <div className='icons'>
                                <img src={icons[2]} alt='noneu' /><span className='icon-text'>Outside EU</span>
                            </div>
                            <div className='icons'>
                                <img src={icons[3]} alt='unknown' /><span className='icon-text'>Not known</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    {selectedPlace && (
                        ...
                        >
                            <div className='restaurant-info'>
                                ...
                                <hr />
                                <p>Cow, country of origin: <strong>{selectedPlace.meat.cow.origin}</strong></p>
                                <p>Pork, country of origin: <strong>{selectedPlace.meat.pork.origin}</strong></p>
                                <p>Chicken, country of origin: <strong>{selectedPlace.meat.chicken.origin}</strong></p>
                                <p>Lamb, country of origin: <strong>{selectedPlace.meat.lamb.origin}</strong></p>
                                <p>Goat, country of origin: <strong>{selectedPlace.meat.goat.origin}</strong></p>
                            </div>
                        </InfoWindow>
                    )}
                </Map>
